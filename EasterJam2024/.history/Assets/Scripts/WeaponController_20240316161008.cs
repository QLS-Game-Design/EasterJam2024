...
public class WeaponController : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        playerController = player.GetComponent<PlayerController>(); // Removed the PlayerController type declaration
        
        // If playerController is null, log an error
    ...
    void Update() {
        ...
        Debug.Log("bruh");
        // Check if playerController is not null before accessing its properties
        if (playerController != null && playerController.isFlipped) {
            Debug.Log("flip");
