...
public class WeaponController : MonoBehaviour
{
    ...
    void Update() {
        ...
        Debug.Log("inputHorizontal" + playerController.)
        if (playerController != null && playerController.inputHorizontal > 0 && !playerController.facingRight) {
            flip();
        } else if (playerController != null && playerController.inputHorizontal < 0 && playerController.facingRight) {
            flip();
        }
    }
